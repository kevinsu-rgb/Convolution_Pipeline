...
#define GO_ADDR 0
#define CLEAR_ADDR 1
#define KERNEL_LOADED_ADDR 2
#define KERNEL_DATA_ADDR 3
#define SIGNAL_SIZE_ADDR 4
#define DONE_ADDR 5

class KernelSizeException : public std::exception {
  const char *what() const throw() { return "Kernel Size Exception"; }
};
...
public:
  ...
  static const unsigned int MAX_SIGNAL_SIZE =
      (RAM_BYTES / sizeof(appWord_t)) -
      2 * (MAX_KERNEL_SIZE - 1) * sizeof(appWord_t);
